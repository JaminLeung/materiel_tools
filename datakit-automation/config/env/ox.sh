...
# API配置
# =============================================================================
CONFIG_UPDATE_OPS_API_URL="${CONFIG_UPDATE_OPS_API_URL:-http://dolphin.ops.pre-ox.internal/api/v2/cmdb/observation-agent}"
...
# 运维平台配置
OPS_ADDR="${OPS_ADDR:-http://dolphin.ops.pre-ox.internal}"
